...
{
    public partial class GpSap : FrmBase
    {
        #region 变量定义
        ...
        private void upLoadData()
        {
            ...
            for (int i = 0; i < tmpRow.Length; i++)
            {
             ...
             strTmpBatch1 = tmpRow[i]["FS_STOVENO"].ToString().Substring(0, 9);
                strTmpBatch2 = (i < (tmpRow.Length - 1)) ? tmpRow[i + 1]["FS_STOVENO"].ToString().Substring(0, 9) : tmpRow[i]["FS_STOVENO"].ToString().Substring(0, 9);
                  ...
                  //  strTmpNo = tmpRow[i]["FS_STOVENO"].ToString();
                    ...
                    if (sTmp != "")
                    {
                      ...
                      //  sapClass.ins261Data(strTmpMater, dTmpZl.ToString(), strTmpNo, uGridData.Rows[i].Cells["FS_SAPSTORE"].ToString());
                        ...
                        sapClass.uptDataFlag("DT_SteelWeightMain", "FS_UPLOADFLAG='1'", "FS_STOVENO like '%" + strTmpNo + "%'");
