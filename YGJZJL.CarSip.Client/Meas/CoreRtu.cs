...
namespace YGJZJL.CarSip.Client.Meas
{
    ...
    public class CoreRtu : CoreDevice
    {
        #region <成员变量>
        string _ipAddr;     // IP地址 
        ...
        /// <returns></returns>
        public static bool DoPingIPStatus(string _ip)
        {
            try
            {
        ...
        /// 打开开关
        /// </summary>
        /// <param name="index">DO索引号0～7</param>
        ...
        /// </summary>
        /// <param name="index">DO索引号0～7</param>
        public void CloseSwitch(int index)
        {
