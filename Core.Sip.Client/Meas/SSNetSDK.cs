...
namespace Core.Sip.Client.Meas
{
    ...
    public unsafe struct LPXNS_DEV_DEVICEINFO
    {
    ...
    public class SSNetSDK
    {
        ...
        [DllImport("SSNetSDK.DLL")]
        public static extern uint XNS_DEV_Login(string sDEVIP, ushort wDEVPort, string sUserName, string sPassword, string sModelName, ref string pContext, IntPtr lpDeviceInfo, bool bBlock, ushort wHttpPort);
