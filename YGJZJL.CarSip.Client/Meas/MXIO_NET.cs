/******************************************************************************************/
/*  Copyright (C) HuNan Steering 2012 All rights reserved.					     		  */
/*                                                                                        */
/*   MOXA SDK C# Wrapper                                                                  */
/*                                                                                        */
/*                                                                                        */
...
/******************************************************************************************/
/*  ---- Important: ----                                                                  */
/*  Windows CE platform not scontain a definition for 'Pack', you will get error CS0117.  */
...
namespace YGJZJL.CarSip.Client.Meas
{
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
        ...
        public static extern int MXEIO_E1K_Connect(byte[] szIP, UInt16 wPort, UInt32 dwTimeOut, Int32[] hConnection, byte[] szPassword);
 		...
 		/***********************************************/
        /*                                             */
        /*    ioLogik 1200 Digital Input command       */
        /*                                             */
        /***********************************************/
 		[DllImport("MXIO_NET.dll")]
		...
		/***********************************************/
        /*                                             */
        /*    ioLogik 1200 Digital output command      */
        /*                                             */
        /***********************************************/
        [DllImport("MXIO_NET.dll")]
        ...
        /***********************************************/
        /*                                             */
        /*     ioLogik 1200 Pulse Output command       */
        /*                                             */
        /***********************************************/
        [DllImport("MXIO_NET.dll")]
        ...
        /***********************************************/
        /*                                             */
        /*    ioLogik 1200 Digital I/O  command        */
        /*                                             */
        /***********************************************/
        [DllImport("MXIO_NET.dll")]
        ...
        /***********************************************/
        /*                                             */
        /*     ioLogik 1200 Analog Input command       */
        /*                                             */
        /***********************************************/
        [DllImport("MXIO_NET.dll")]
        ...
        /***********************************************/
        /*                                             */
        /*       ioLogik 1200 Relay Count & Reset      */
        /*                                             */
        /***********************************************/
        [DllImport("MXIO_NET.dll")]
        ...
        /***********************************************/
        /*                                             */
        /*    ioLogik 1200 special Module command      */
        /*                                             */
        /***********************************************/
        [DllImport("MXIO_NET.dll")]
        ...
        public const int ACTTAG_IOPAC8020T_ID		= 0x180;
        ...
        public const int ACTTAG_VIRTUAL_CH_DISABLE    		= 206;	//W5340+E1000 Virtual channel disable
        public const int ACTTAG_VIRTUAL_CH_VALUE      		= 207;	//W5340+E1000 Virtual channel
        ...
        public const int E4200_SERIES 						= 3;
        public const int E1200_SERIES 						= 4;
        public const int W5000_SERIES 						= 5;
        /*************************************************/
        /*                                               */
