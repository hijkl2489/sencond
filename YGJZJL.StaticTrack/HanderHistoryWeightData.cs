...
{
    public partial class HanderHistoryWeightData : FrmBase
    {
        BaseInfo objBi = null;
        ...
        public HanderHistoryWeightData()
        {
            InitializeComponent();
        ...
        private bool CheckInPut()//输入检查
        {
            ...
            {
                MessageBox.Show("请输入皮重重量!");

                txtTareWeight.Focus();
                return false;
            }
            if (txtTareWeight.Text.Length > 10)
            {
                MessageBox.Show("皮重不能超过10位数!");
                txtTareWeight.Focus();
                return false;
            ...
            try
            {
                ...
                Convert.ToDouble(txtTareWeight.Text);
                if (Convert.ToDouble(txtGrossWeight.Text) < Convert.ToDouble(txtTareWeight.Text))
                {
                    MessageBox.Show("毛重不要能小于皮重!请从新输入!");
                    return false;
                }
            }
            catch
        ...
        private void ultraGrid1_DoubleClickRow(object sender, DoubleClickRowEventArgs e)
        {
            ...
            cbWeightPoint.Text=ultraGrid1.Rows[rowno].Cells["FS_GROSSPOINT"].Text.ToString();
            ...
            txtGrossWeight.Text = ultraGrid1.Rows[rowno].Cells["FN_GROSSWEIGHT"].Text.ToString();
            txtTareWeight.Text = ultraGrid1.Rows[rowno].Cells["FN_TAREWEIGHT"].Text.ToString();
       ...
       */
        ...
        private void queryHistoryDataByDate()
        {
            ...
            string sql = "select t.fs_weightno,t.fs_material, t.fs_weighttype, t.fs_senderstoreno, t.fs_receiverstoreno,"
                         ...
                         + " where T.FS_GROSSPOINT='K12' AND t.fs_material = ma.fs_wl(+) and t.fs_senderstoreno = fh.fs_gy(+) and t.fs_receiverstoreno = sh.fs_sh(+)"
       ...
       //新增历史数据
        private bool AddHistoryData()
        {
            ...
            string strTareWeightTime = this.dtpTareTime.Value.ToString("yyyy-MM-dd HH:mm:ss");
            ...
            string strNetWeight = (Convert.ToDouble(strGrossWeight) - Convert.ToDouble(strTareWeight)).ToString();
            string strWeightPoint = cbWeightPoint.SelectedValue.ToString();
            ...
            strTmpField = "FS_WEIGHTNO,FS_MATERIAL,FS_WEIGHTTYPE,FS_SENDERSTORENO,FS_RECEIVERSTORENO,"//1
                        + " FS_TRAINNO,FN_GROSSWEIGHT,FS_GROSSPERSON,FS_GROSSPOINT,FD_GROSSTIME,"//2
                        ...
                        + " FS_RECEIVER,FD_RECEIVETIME,FS_MEMO,FS_TRANS,FD_UPDATETIME ";//6


            strTmpValue = "'" + strWeightNo + "','" + strMaterial + "','" + strFlow + "','" + strSender + "','" + strReceiver + "','"//1
                + strTrainNo + "','" + strGrossWeight + "','" + strUserName + "','" + strWeightPoint + "',to_date('" + strGrossWeightTime + "','yyyy-MM-dd hh24:mi:ss'),'"//2
                + strTareWeight + "','" + strUserName + "','" + strWeightPoint + "',to_date('" + strTareWeightTime + "','yyyy-MM-dd hh24:mi:ss'),'" + strNetWeight + "','"//3
                + "" + "','" + "" + "','" + "" + "','" + strShift + "','" + strGroup + "','"//4
                + strShift + "','" + strGroup + "','" + "" + "','"//5
                + "" + "','" + "" + "" + "','" + strUserName+" 补录" + "','" + strTrans + "',to_date('"+strUpdateTime+"','yyyy-MM-dd hh24:mi:ss')";//6
            ...
            + cbFlow.Text + ",毛重=" + txtGrossWeight.Text + ",皮重="//流向、重量
            + txtTareWeight.Text + ",";
            ...
            if (ccpLog.ReturnCode == 0)
            {
                ...
                BaseOperation();
                this.objBi.WriteOperationLog("DT_STATICTRACKWEIGHT_WEIGHT", strDepartMent, strUserName, "增加", strLog, "二次数据补录", "静态轨道衡一次数据表", "静态轨道衡");//调用写操作日志方法
        ...
        private void UpdateHistoryData()
        {
            ...
            strTmpField = " FS_TRAINNO='" + strTrainNo + "',FS_MATERIAL='" + strMaterial + "',FS_WEIGHTTYPE='" + strFlow + "',"
                       ...
                       + " FS_TRANS='" + strTrans + "',FD_UPDATETIME=to_date('" + strUpdateTime + "','yyyy-MM-dd hh24:mi:ss'),"
                       + " FN_GROSSWEIGHT='"+strGrossWeight+"',FN_TAREWEIGHT='"+strTareWeight+"',FN_NETWEIGHT='"+strNetWeight+"',FS_MEMO='"+strUserName+" 修改'";
            ...
            string strGrossWEIGHTLog = this.ultraGrid1.Rows[rowno].Cells["FN_GROSSWEIGHT"].Text;
            string strTareWEIGHTLog = this.ultraGrid1.Rows[rowno].Cells["FN_TAREWEIGHT"].Text;
            string strNetWEIGHTLog = this.ultraGrid1.Rows[rowno].Cells["FN_NETWEIGHT"].Text;
            ...
            string strLog = "车号：" + strCarNoLog + ">" + strTrainNo + ",物料："//卡号、车号
                ...
                + strWeighttypeLog + ">" + cbFlow.Text + ",毛重：" + strGrossWEIGHTLog + ">" + strGrossWeight + ",皮重："//流向、重量
                + strTareWEIGHTLog + ">" + strTareWeight + ",净重：" + strNetWEIGHTLog + ">" + strNetWeight + ",";
            ...
            if (ccp.ReturnCode == 0)
            {
                ...
                MessageBox.Show("数据保存成功！");
                BaseOperation();
                this.objBi.WriteOperationLog("DT_STATICTRACKWEIGHT_WEIGHT", strDepartMent, strUserName, "修改", strLog, "二次数据补录", "静态轨道衡二次数据表", "静态轨道衡");//调用写操作日志方法
        ...
        private void DeleteHistoryData()
        {
            ...
            string strDeleteTime = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            string strTmpTable, strTmpField, strTmpWhere;
            strTmpTable = "DT_STATICTRACKWEIGHT_WEIGHT";
            strTmpField = " FS_DELETEFLAG='1',FD_DELETEDATE=to_date('" + strDeleteTime + "','yyyy-MM-dd hh24:mi:ss'),FS_MEMO='" + strUserName + " 删除'";
            strTmpWhere = " FS_WEIGHTNO='" + strOp + "' and fs_trainno='" + this.ultraGrid1.Rows[rowno].Cells["FS_TRAINNO"].Text + "'";
            CoreClientParam ccp = new CoreClientParam();
            ccp.ServerName = "ygjzjl.base.QueryData";
            ccp.MethodName = "check_UpdateInfo";
            ccp.ServerParams = new object[] { strTmpTable, strTmpField, strTmpWhere };
            ...
            {
                MessageBox.Show(e1.Message + "数据删除失败！");
                return;
            }
            ...
            if (ccp.ReturnCode == 0)
            {
                ...
                this.objBi.WriteOperationLog("DT_STATICTRACKWEIGHT_WEIGHT", strDepartMent, strUserName, "删除", strLog, "二次数据补录", "静态轨道衡二次数据表", "静态轨道衡");//调用写操作日志方法
