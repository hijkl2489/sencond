...
namespace YGJZJL.DynamicTrack.access
{
    public class AccessData
    {
        ...
        /// 连接数据库字符串
        /// </summary>
        private static string connectionString = @"Provider=Microsoft.Jet.OLEDB.4.0; Data Source=\\10.32.3.204\\cz\\database\\GDH1.mdb";
