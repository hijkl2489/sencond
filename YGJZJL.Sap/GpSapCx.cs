...
{
    public partial class GpSapCx : FrmBase
    {
        #region 变量定义
        ...
        private void showGridInfo()
        {
            ...
            strTmpField = "TO_CHAR(t.FD_STARTTIME,'yyyy-MM-dd HH24:mi:ss') AS GBSJ,t.FS_STOVENO,t.FS_PRODUCTNO,"
                + "t.FS_ITEMNO,t.FS_SAPSTORE,t.FS_UPLOADFLAG,t.FS_ACCOUNTDATE,t.FS_HEADER,"
               +"t.FS_STEELTYPE,t.FS_SPEC,t.FS_AUDITOR,";
