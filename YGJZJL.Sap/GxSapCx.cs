...
{
    public partial class GxSapCx : FrmBase
    {
        #region 变量定义
        ...
        private void showGridInfo()
        {
            ...
            strTmpTable = "DT_GX_STORAGEWEIGHTMAIN t";
            strTmpField = "TO_CHAR(t.FD_STARTTIME,'yyyy-MM-dd HH24:mi:ss') AS GBSJ,t.FS_BATCHNO,t.FS_PRODUCTNO,"
                + "t.FS_ITEMNO,t.FS_SAPSTORE,t.FS_UPLOADFLAG,t.FS_ACCOUNTDATE,t.FS_HEADER,";

            strTmpField += " (select sum( r.FN_WEIGHT) from DT_GX_STORAGEWEIGHTDETAIL r where r.FS_BATCHNO=t.FS_BATCHNO and r.FS_UPLOADFLAG='1') as  FN_TOTALWEIGHT,";
            strTmpField += "(select count( r.FS_WEIGHTNO) from DT_GX_STORAGEWEIGHTDETAIL r where r.FS_BATCHNO=t.FS_BATCHNO and r.FS_UPLOADFLAG='1')  as FN_BANDCOUNT";
        ...
        private void showMxsj(string sLh)
        {
            ...
            strTmpField = "FS_BATCHNO,FN_BANDNO,FN_WEIGHT,FD_DATETIME";
        ...
        private void unLoadData()
        {
            ...
            {
                strTmpWhere = "FS_BATCHNO='" + strOptNo + "' AND FS_ACCOUNTDATE='" + strOptJzrq + "'";
