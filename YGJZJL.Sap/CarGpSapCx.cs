...
{
    public partial class CarGpSapCx : FrmBase
    {
        #region 变量定义
        ...
        private bool getStrWhere()
        {
            ...
            if (txtLh.Text.Trim() != "")
            {
                strWhere += " AND FS_GP_STOVENO LIKE '" + txtLh.Text.Trim() + "%'";
            }
        ...
        private void showGridInfo()
        {
            ...
            strTmpField = "TO_CHAR(FD_GP_JUDGEDATE,'yyyy-MM-dd HH24:mi:ss') AS GBSJ,FS_GP_STOVENO as FS_STOVENO,FS_PRODUCTNO,"
                + "FS_ITEMNO,FS_PLANT,FS_SAPSTORE,FS_UPLOADFLAG,FN_JJ_WEIGHT as FN_NETWEIGHT,FS_ACCOUNTDATE, FN_GP_TOTALCOUNT as FN_BILLETCOUNT";
        ...
        private void unLoadData()
        {
            ...
            {
                strTmpNo = "FS_GP_STOVENO like '%" + strOptNo + "%'";
