...
{
    public partial class BcSapFl : FrmBase
    {
        #region 变量定义
        ...
        private bool getStrWhere()
        {
         ...
         //   strWhere += " AND FS_DRDW='棒线厂四作'";
            ...
            strWhere += " AND FS_SAPSTORE = '1311'";//玉钢棒材库
            return true;
        }
        ...
        private void uGridData_DoubleClickCell(object sender, Infragistics.Win.UltraWinGrid.DoubleClickCellEventArgs e)
        {
            ...
            txtKcd.Text = uGridData.ActiveRow.Cells["FS_SAPSTORE"].Text != "" ? uGridData.ActiveRow.Cells["FS_SAPSTORE"].Text : "1311";
