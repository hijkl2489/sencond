...
{
    public partial class UpdateFirstWeight : FrmBase
    {
        ...
        private void Query()
        {
            ...
            sql += "A.Fs_Senderstore,A.FS_RECEIVERSTORE,E.FS_TRANSNAME,F.FS_TYPENAME,G.FS_POINTNAME,A.FN_WEIGHT,";
                   ...
                   sql += " A.FS_UNLOADPERSON,to_char(A.FD_UNLOADTIME, 'yyyy-MM-dd hh24:mi:ss') as FD_UNLOADTIME,FS_UNLOADPLACE,FS_UNLOADFLAG,";
        ...
        private void Update()
        {
            ...
            string strSender = this.cbFHDW.SelectedValue.ToString().Trim();
           ...
           // string strMaterialName = this.cbMaterial.Text.Trim();
            ...
            double intweight = Math.Round(Convert.ToDouble(this.tbWeight.Text.Trim()), 3);
            ...
            this.objBi.WriteOperationLog("DT_FIRSTCARWEIGHT", strDepartMent, strUserName, "修改", strLog, "一次数据修改", "汽车衡一次数据表", "汽车衡");//调用写操作日志方法
       ...
       */
        ...
        private void cbWLMC_TextChanged(object sender, EventArgs e)
        {
            ...
            m_ListType = "Material";
            m_List.Location = new System.Drawing.Point(70, 85);
        ...
        private void cbFHDW_TextChanged(object sender, EventArgs e)
        {
            ...
            m_ListType = "Sender";
            m_List.Location = new System.Drawing.Point(327, 85);
        ...
        private void cbSHDW_TextChanged(object sender, EventArgs e)
        {
            ...
            m_ListType = "Reveiver";
            m_List.Location = new System.Drawing.Point(70, 120);
        ...
        private void cbCYDW_TextChanged(object sender, EventArgs e)
        {
            ...
            m_ListType = "Trans";
            m_List.Location = new System.Drawing.Point(327, 120);
