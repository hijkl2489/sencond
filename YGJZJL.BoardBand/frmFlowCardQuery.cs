...
namespace YGJZJL.BoardBand
{
    public partial class frmFlowCardQuery : FrmBase
    {
        ...
        private void GetFlowCardInfo()
        {
            ...
            strSql += Convert.ToString("       decode(nvl(t1.fs_gp_flow, t.fs_receiver),'SH000098','棒材厂','SH000100','中宽带厂','SH000120','型材厂','SH000166','炼钢落地',t1.fs_gp_flow) fs_gp_flow,").Trim() + " ";
            ...
            strSql += Convert.ToString("               sum(nvl(x.fn_weight, 0)) fn_jj_weight").Trim() + " ";
            strSql += Convert.ToString("          from dt_boardweightmain x").Trim() + " ";
