...
namespace YGJZJL.Car
{
    ...
    class PoundRoom
    {
        ...
        private decimal m_CLEARVALUE;//重量稳定值
        ...
        private CoolReader m_CoolReader;//读卡器
        ...
        private int m_Channel7;//通道7句柄
        private int m_Channel8;//通道8句柄
        private bool m_bTalk;//是否正在对讲
        private int m_TalkID;//对讲句柄
        private int m_AudioNum; //可使用音频数
        private bool m_IsFirstSend; //是否播放过语音
        ...
        private void DataCollectThread()
        {
            try
            {
                while (m_bRunning)
                {
                    ...
                    System.Threading.Thread.Sleep(100);//请根据需要调整线程运行周期
                }
            }
        ...
        //    SendCustomVoiceData("D:\\计量完成1.wav");//提供文件路径
        //}
        ////语音对讲
        //private void sendDJ()
        //{
